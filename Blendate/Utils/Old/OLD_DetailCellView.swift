...
//    
//    func tapped(){
//        print("Tapped \(detail.label) Detail")
...
//            } label: {
//                HStack {
//                    Text(details.valueLabel(for: detail))
...
//        DetailCellView2(detail: .relationship, details: dev.$bindingMichael.details)
//            .previewLayout(.sizeThatFits)
//        
//        DetailCellView2(detail: .mobility, details: dev.$bindingMichael.details)
//            .previewLayout(.sizeThatFits)
//        
//        DetailCellView2(detail: .education, details: dev.$bindingMichael.details)
//            .previewLayout(.sizeThatFits)
//    }
//}
//
