...
const iosMatchNotifications = functions.firestore.document('matches/{mid}').onCreate(
    async (snapshot) => {
...
const iosChatNotifications = functions.firestore.document("matches/{uid}").onUpdate(
    async (change, event) => {
...
module.exports = {
    iosMatchNotifications,
    iosChatNotifications,
