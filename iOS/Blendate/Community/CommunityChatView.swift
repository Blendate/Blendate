...
//        self._model = StateObject(wrappedValue: ChatViewModel(cid: topic.id))
//    }
//    
...
//                    .font(.semibold, .largeTitle, .DarkBlue)
...
//    }
//
//    static let topic = CommunityTopic(author: alice.id!, title: "Travel Tips & Tricks", subtitle: "Single Mom gives advice on how to travel with kids")
//}
