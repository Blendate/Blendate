...
//
//
//struct FilterCellView2: View {
//    let filter: SignupDetail
//    @Binding var filters: Stats
//    let width: CGFloat
//
//    var body: some View {
//        HStack {
...
//    
//    func tapped(){
//        print("Tapped \(filter.label) Detail")
////        print("Value: \(details.valueLabel(for: detail))")
//    }
//    
//    var value: some View {
...
//            } label: {
//                HStack {
////                    Text(filters.valueLabel(for: detail))
...
//        FilterCellView2(filter: .ethnicity, filters: dev.$bindingMichael.filters, width: 300)
//            .previewLayout(.sizeThatFits)
//        FilterCellView2(filter: .height, filters: dev.$bindingMichael.filters, width: 300)
//            .previewLayout(.sizeThatFits)
//
//        FilterCellView2(filter: .maxDistance, filters: dev.$bindingMichael.filters, width: 300)
//            .previewLayout(.sizeThatFits)
//        
//        FilterCellView2(filter: .ageRange, filters: dev.$bindingMichael.filters, width: 300)
//            .previewLayout(.sizeThatFits)
//
//    }
//}
